    ...
    public function webConfSubmit()
    {
    	if($this->request->isPost()){
            ...
            if ($result !== true) {
                ...
                $conf = "<?php return ['admin_title'=>'{$param["admin_title"]}','title'=>'{$param["title"]}','keywords'=>'{$param["keywords"]}','logo'=>'{$param["logo"]}','desc'=>'{$param["desc"]}','icp'=>'{$param["icp"]}','zscx'=>'{$param["zscx"]}','phone'=>'{$param["phone"]}','copyright'=>'{$param["copyright"]}','slogan'=>'{$param["slogan"]}'];";
