<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"themes/admin_themes/view/publicer\login.html";i:1542862370;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title><?php echo vae_get_config('webconfig.admin_title') ? vae_get_config('webconfig.admin_title') : 'vaeThink'; ?></title>
    ...
    <body>
    	<div class="vaeyo-login-body">
            <h2><?php echo vae_get_config('webconfig.admin_title') ? vae_get_config('webconfig.admin_title') : 'vaeThink'; ?></h2>
