<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"themes/admin_themes/view/userdynamic\index.html";i:1562477093;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <a class="layui-btn layui-btn-primary layui-btn-sm" href="/admin/userdynamic/add">添加动态</a>
  </div>
</script>
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs layui-btn-primary" href="/admin/userdynamic/edit/id/{{d.id}}">编辑</a>
...
layui.config({
  ...
  var tableIns = table.render({
    elem: '#test'
    ,toolbar: '#toolbarDemo'
    ,url: '/admin/userdynamic/getUserList' //数据接口
    ,page: true //开启分页
    ,limit: 15
    ,cols: [[ //表头
