<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"themes/admin_themes/view/route\index.html";i:1544409030;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <a class="layui-btn layui-btn-primary layui-btn-sm" href="/admin/route/add">添加路由</a>
  </div>
</script>
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs layui-btn-primary" href="/admin/route/edit/id/{{d.id}}">编辑</a>
