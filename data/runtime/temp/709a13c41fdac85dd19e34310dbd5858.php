<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpstudy\PHPTutorial\WWW\gds\public/../app/port\view\trends\index.html";i:1562468900;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\header.html";i:1547981714;s:61:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\nav.html";i:1552984613;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\footer.html";i:1553874201;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title>协会动态-<?php echo $conf['title']; ?></title>
			...
			<div class="right">
				<div class="right_title flex">
					...
					<div class="right_title_r c_white flex">
						<p>当前位置：<span><span href="javascript:;">协会动态</span></span><span style="font-size: 14px;margin: 0 5px;">></span><span><span><?php echo $map; ?></span></span></p>
					</div>
				</div>
				<div class="r_conter">
					<div>
						...
						<div class="list_text">
							<ul>
								<?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
										<a class="list_a flex" href="<?php echo url('port/Trends/details',['article_id'=>$vo['id'],'cateid'=>$cateid]); ?>">
											<p class="flex">
