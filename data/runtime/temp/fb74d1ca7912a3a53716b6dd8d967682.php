<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"D:\phpstudy\PHPTutorial\WWW\gds\public/../app/port\view\user\lst.html";i:1562474144;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\header.html";i:1547981714;s:61:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\nav.html";i:1552984613;s:60:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\user\left.html";i:1550742480;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\footer.html";i:1553874201;}*/ ?>
<!DOCTYPE html>
<html>
...
<meta name="description" content="<?php echo $conf['desc']; ?>">
	...
	<link rel="stylesheet" type="text/css" href="/static/myhome/css/download.css"/>
	<body>
		<style>
	.title_text>p{
		color: #ffffff;
			...
			<div class="right">
				<div class="right_title flex">
					<div class="flex right_l">
						<i class="icon"></i>
						<p class="c_white">会员动态</p>
					</div>
					<div class="right_title_r c_white flex">
						<p>当前位置：<span><span>会员风采</span></span><span style="font-size: 14px;margin: 0 5px;">></span><span><span>会员动态</span></span></p>
					</div>
				</div>
				<div class="r_conter">
					<div>
						...
						<div class="list_text">
							<ul>
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
										<a class="list_a flex" href="<?php echo url('port/user/detailsu',['id'=>$vo['id']]); ?>">
											<p class="flex">
