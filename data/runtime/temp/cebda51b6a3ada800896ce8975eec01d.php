<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"themes/admin_themes/view/user\edit.html";i:1562476354;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form vae-content">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <span>建议：图片大小比例：140×90</span>
      <div class="layui-upload">
        <button type="button" class="layui-btn" id="test1">上传封面</button>
        <div class="layui-upload-list" id="demo1">
          <img src="<?php echo $User['file']; ?>" width="100" />
          <input type="hidden" name="file" value="<?php echo $User['file']; ?>">
        </div>
      </div>
    </div>
  </div>
