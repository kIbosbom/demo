<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"themes/admin_themes/view/article\index.html";i:1554290367;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <form class="layui-form" style="display: inline;">
    ...
    <div class="layui-inline">
      <select lay-filter="business" name="business" lay-search="">
        ...
        <?php $_result=vae_set_recursion(vae_get_article_cate());if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(($v['id'] != 7) AND ($v['id'] != 8) AND ($v['id'] != 9) AND ($v['id'] != 3)): ?>
