<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpstudy\PHPTutorial\WWW\gds\public/../app/port\view\news\index.html";i:1562474811;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\header.html";i:1547981714;s:61:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\nav.html";i:1552984613;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\footer.html";i:1553874201;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<title>行业信息-<?php echo $conf['title']; ?></title>
						...
						<?php if(is_array($node) || $node instanceof \think\Collection || $node instanceof \think\Paginator): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			                <li class="list_li">
			                    <?php if($vo['childer']): ?>
			                       <a href="javascript:;">
			                    <?php else: ?>
			                        <a href="<?php echo url('port/News/index',['article_id'=>$vo['id'],'cateid'=>$cateid]); ?>"> 
			                    <?php endif; ?>
			                        <div class="flex">
			                    ...
			                    <div class="drop_down">
			                        <?php if(is_array($vo['childer']) || $vo['childer'] instanceof \think\Collection || $vo['childer'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['childer'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			                            <p>
			                                <a href="<?php echo url('port/News/index',['article_id'=>$v['id'],'cateid'=>$cateid]); ?>"><?php echo $v['title']; ?></a>
			                            </p>
			                        <?php endforeach; endif; else: echo "" ;endif; ?>
			                    </div>
			                </li>
			...
			<div class="right">
				<div class="right_title flex">
					...
					<div class="right_title_r c_white flex">
						<p>当前位置：<span><span>行业信息</span></span><span style="font-size: 14px;margin: 0 5px;">></span><span><span><?php echo $map; ?></span></span></p>
					</div>
				</div>
				<div class="r_conter">
					<div>
						...
						<div class="list_text">
							<ul>
								<?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
										<a class="list_a flex" href="<?php echo url('port/News/details',['article_id'=>$vo['id'],'cateid'=>$cateid]); ?>">
											<p class="flex">
