<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpstudy\PHPTutorial\WWW\gds\public/../app/port\view\article\index.html";i:1562473044;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\header.html";i:1547981714;s:61:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\nav.html";i:1552984613;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\footer.html";i:1553874201;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<title>协会概况-<?php echo $conf['title']; ?></title>
						...
						<?php if(is_array($node) || $node instanceof \think\Collection || $node instanceof \think\Paginator): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			                <li class="list_li">
			                    <?php if($vo['childer']): ?>
			                       <a href="javascript:;">
			                    <?php else: ?>
									<a href="<?php echo url('port/article/index',['article_id'=>$vo['id'],'cateid'=>$cateid]); ?>">
			                    <?php endif; ?>
			                        <div class="flex">
			                    ...
			                    <div class="drop_down">
			                        <?php if(is_array($vo['childer']) || $vo['childer'] instanceof \think\Collection || $vo['childer'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['childer'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			                            <p>
											<!-- <a href="<?php echo url('port/article/index',['article_id'=>$v['id'],'cateid'=>$cateid]); ?>"><?php echo $v['title']; ?></a> -->
											<a href="javascript:;" onclick="ajaxText($article_id = <?php echo $v['id'];?>,cateid = <?php echo $cateid ?>)"><?php echo $v['title']; ?></a>						
			                            </p>
			                        <?php endforeach; endif; else: echo "" ;endif; ?>
			                    </div>
			                </li>
			...
			<div class="right">
				<div class="right_title flex">
					<div class="flex"><i class="icon"></i>
						<p class="c_white s_name"><?php echo $map; ?></p>
					</div>
					<div class="right_title_r c_white flex">
						<p>当前位置：<span><span>协会概况</span></span><span style="font-size: 14px;margin: 0 5px;">></span><span><span id="maf"></span><span class="s_name"><?php echo $map; ?></span></span></p>
					</div>
				</div>
				<div class="r_conter">
					<div>
...
<script>
	...
	(function(){
		...
		<script src="/static/myhome/js/jquery-1.11.1.min.js"></script>
		<script type="text/javascript">
			//ajax 文章
			function ajaxText(article_id,cateid){
				$.ajax({
					type: "post",
					url: "<?php echo url('port/article/ajaxText'); ?>",
