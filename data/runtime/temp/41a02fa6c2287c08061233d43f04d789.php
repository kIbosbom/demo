<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpstudy\PHPTutorial\WWW\gds\public/../app/port\view\download\index.html";i:1550755527;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\header.html";i:1547981714;s:61:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\nav.html";i:1552984613;s:64:"D:\phpstudy\PHPTutorial\WWW\gds\app\port\view\public\footer.html";i:1553874201;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<title>资料下载-<?php echo $conf['title']; ?></title>
		...
		<div class="container flex">
			<div class="left">
				...
				<div class="list">
					<ul class="list_ul">
						<li class="list_li">
							<a href="<?php echo url('port/Download/index'); ?>">
								<div class="flex">
						...
						<div class="list_text">
							<ul>
								<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
										<a class="list_a flex" download="" href="<?php echo $vo['img']; ?>">
											<p class="flex">
